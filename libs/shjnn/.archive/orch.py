...
def train(func, rec, dec, optim, trajs, times, n_epochs, n_batch, device, beta = None):
    ...
    for epoch in range(1, n_epochs+1):
        ...
        try:
            ...
            for x_batch, y_batch in train_loader:
                ...
                _loss = train_step(x_batch, y_batch)
                loss.append(_loss)
            ...
            print('{} : {:.0f}, {:.0f}'.format(epoch, epoch_loss, np.median(loss)))


            # save model state
            path = '../data/models/ckpt_{}.pth'.format(epoch)
